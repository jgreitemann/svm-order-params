...
struct dice : bravais<Site, 2ul, 3ul> {
        ...
        -> std::array<const_iterator, coordination>
    {
        ...
        case 0:
        {
            ...
            return {
                ...
                const_iterator{down.up(1), 1},
                const_iterator{down.down(1), 2},
                const_iterator{down, 1},
                const_iterator{down, 2},
            };
        }
        case 1:
        {
...
template <typename Site>
struct serializer<frustmag::lattice::dice<Site>>
    : frustmag::lattice::serializer<frustmag::lattice::dice<Site>> {};
